...
class ScannerScreen : Screen {
    ...
    override fun Content() {
        ...
        var selectedScreen by remember { mutableStateOf("generator") }
        ...
        Column {
            Row(
                ...
                Button(onClick = { selectedScreen = "generator" }) { Text("Generate QR") }
                Button(onClick = { selectedScreen = "scanner" }) { Text("Scan QR") }
            }

            when (selectedScreen) {
                "generator" -> QRCodeGeneratorScreen()
